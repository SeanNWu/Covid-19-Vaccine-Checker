...
public class MainActivity3 extends AppCompatActivity {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                for(int count =0; count < vaccinesSample.size()  ;count++)
                {
                    ...
                    {
                        output.setText("On the date " + vaccinesSample.get(count).getDate() + " in the Country " + vaccinesSample.get(count).getCountry() + " there were " + vaccinesSample.get(count).getNumberOfDose() + " vaccine doses given");
                    }
    ...
    private void readVaccineData(){
        ...
        {
            Log.wtf("MyActivity3","Error reading data file on line " + line,e);
            e.printStackTrace();
        }
